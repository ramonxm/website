...
> **Finding Your Project ID**: Navigate to your GitLab repository settings. The Project ID is the number in the URL after the slash: `https://gitlab.com/<your_user>/<your_repository>/edit` → Project ID: 123456
...
1. Create an `.npmrc` file in the root of your consuming project:
